...
namespace Proxies\__CG__\Dojo\LoginBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Usuario extends \Dojo\LoginBundle\Entity\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Dojo\\LoginBundle\\Entity\\Usuario' . "\0" . 'id', '' . "\0" . 'Dojo\\LoginBundle\\Entity\\Usuario' . "\0" . 'password', '' . "\0" . 'Dojo\\LoginBundle\\Entity\\Usuario' . "\0" . 'email', '' . "\0" . 'Dojo\\LoginBundle\\Entity\\Usuario' . "\0" . 'nombre', '' . "\0" . 'Dojo\\LoginBundle\\Entity\\Usuario' . "\0" . 'apellido', '' . "\0" . 'Dojo\\LoginBundle\\Entity\\Usuario' . "\0" . 'celular', '' . "\0" . 'Dojo\\LoginBundle\\Entity\\Usuario' . "\0" . 'salt');
        }
